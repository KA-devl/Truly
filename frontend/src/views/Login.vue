  ...
  <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    ...
    <div class="md:w-1/2 px-8 md:px-16">
      ...
      <form @submit.prevent="login" class="flex flex-col gap-4">
        <input class="p-2 mt-8 rounded-xl border" v-model=username type="username" name="username" placeholder="Username">
        <div class="relative">
          <input class="p-2 rounded-xl border w-full" v-model=password type="password" name="password" placeholder="Password">
    ...
    <div class="md:block hidden w-1/2">
      <img class="rounded-2xl" src="https://images.pexels.com/photos/4065620/pexels-photo-4065620.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
    </div>
  </div>
</section>
</template>
...
export default{
  setup(){
    ...
    return {username, password, login, userStore}
