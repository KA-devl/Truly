...
<div v-if="isModalOpen" class="fixed z-50 top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 bg-red-100">
    <div class="relative w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button @click="isModalOpen = false" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="crypto-modal">
  ...
  <button v-if="selectedForInterviewJobs" @click="isModalOpen = true" type="button" 
    class="relative inline-flex items-center p-3 text-md  text-center text-white bg-blue-400 rounded-lg hover:bg-blue-500 focus:ring-4 focus:outline-none mt-3 "> You have ({{ selectedForInterviewJobs.length }}) job interview scheduled 
