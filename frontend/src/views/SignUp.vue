    ...
    <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
      ...
      <div class="md:w-1/2 px-8 md:px-16">
        ...
        <form @submit.prevent="register" class="flex flex-col gap-4">
          ...
          <div class="relative">
            <input class="p-2 rounded-xl border w-full" v-model=password :type="showPassword ? 'text' : 'password'"  name="password"
              placeholder="Password">
            <svg xmlns="http://www.w3.org/2000/svg" @click="showPassword = !showPassword" width="16" height="16" fill="gray"
          ...
          <div class="relative">
            <input class="p-2 rounded-xl border w-full"  :type="showPassword ? 'text' : 'password'" v-model=confirmPassword 
