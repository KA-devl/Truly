<template>
    <tr>
                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                    <div>
                                        <h2 class="font-medium text-gray-800 dark:text-white ">{{ title }}</h2>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <h4 class="text-gray-700 dark:text-gray-200"> {{ endDate }}</h4>
                                        <!-- <p class="text-gray-500 dark:text-gray-400">Web-based sales doc management</p> -->
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <h4 class="text-gray-700 dark:text-gray-200"> {{ applicantCount }}</h4>
...
export default {
    props : ['title', 'status', 'endDate', 'applicantCount'],
